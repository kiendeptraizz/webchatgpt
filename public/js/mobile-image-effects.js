...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document
        .querySelectorAll(
            ".package-card, .card, .tech-frame-mobile, .category-header"
        )
        .forEach((el) => {
    ...
    // Removed tilt effect to prevent continuous rotation issues

    // Add zoom effect to images
    document
        .querySelectorAll(
            ".testimonial-avatar, .service-badge img, .category-icon"
        )
        .forEach((img) => {
